...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add Suspect Classification Information</h3>
        </div>
        <div class="card-body">
            <form action="/suspect_classification_add" role="form" method="post">
                @csrf
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Save Suspect Classification</button>
                </div>
            </form>
        </div>
        <div class="card-footer">
            <h6>Create Suspect Classification maintenance data.</h6>
        </div>
    </div>
    <!-- /.card -->
