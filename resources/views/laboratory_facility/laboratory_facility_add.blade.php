...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add Laboratory Facility Information</h3>
        </div>
        <div class="card-body">
            <form action="/laboratory_facility_add" role="form" method="post">
                @csrf
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Laboratory Facility Name" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <div>
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Save Laboratory Facility</button>
                </div>
            </form>
        </div>
