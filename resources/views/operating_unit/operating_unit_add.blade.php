...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add Operating Unit Information</h3>
        </div>
        <div class="card-body">
            <form action="/operating_unit_add" role="form" method="post">
                @csrf
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Operating Unit Name" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <div>
                    ...
                    <div class="input-group mb-3">
                        <input id="description" name="description" type="text" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" placeholder="Operating Unit Description" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <div>
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Save Operating Unit</button>
                </div>
            </form>
        </div>
        <div class="card-footer">
            <h6>Create Operating Unit maintenance data.</h6>
        </div>
    </div>
    <!-- /.card -->
