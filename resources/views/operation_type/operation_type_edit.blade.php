...
<section class="content">
    ...
    <div class="card card-success">
        ...
        <div class="card-body">
            <form action="/operation_type_edit/{{ $operation_type[0]->id }}" role="form" method="post">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') ?? $operation_type[0]->name }}" placeholder="Operation Type Name" autocomplete="off">
                    </div>
                </div>
                <div class="custom-control custom-checkbox mb-2">
                    <input name="is_warrant" class="custom-control-input" type="checkbox" id="customCheckbox1" {{ $operation_type[0]->is_warrant == true ? 'checked' : ''}}>
                    <label for="customCheckbox1" class="custom-control-label">Is Warrant</label>
                </div>
                <div class="custom-control custom-checkbox mb-2">
                    <input name="is_testbuy" class="custom-control-input" type="checkbox" id="customCheckbox2" {{ $operation_type[0]->is_testbuy == true ? 'checked' : ''}}>
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Update Operation Type</button>
                </div>
            </form>
        </div>
