...
<section class="content">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Add Operation Category Information</h3>
        </div>
        <div class="card-body">
            <form action="/operation_category_add" role="form" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Operation Category Name" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Save Operation Category</button>
                </div>
            </form>
        </div>
