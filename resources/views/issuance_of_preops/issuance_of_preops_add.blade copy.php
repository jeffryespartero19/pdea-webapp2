                                                ...
                                                <table id="aop" class="table table-hover text-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr class="area_details">
                                                            ...
                                                            <td>
                                                                <select name="area_region_c[]" @if(Auth::user()->user_level_id == 1) class="form-control change_control cc2 area_region_c" @else class="form-control change_control cc2 area_region_c region_c disabled_field" @endif style="width: 300px;">
    ...
    $(document).ready(function() {
        $(document).on("click", ".addArea", function() {
            ...
            if (userlvlid == 1) {
                ...
                html += '<td><input type="text" name="area[]" class="form-control" placeholder="Area" value="N/A"  style="width: 200px;"></td>';
                html +=
                    '<td><select required name="area_region_c[]" }}" class="form-control area_region_c"><option value="0" selected>None</option>@foreach ($region as $rg)<option value="{{ $rg->region_c }}">{{ $rg->abbreviation }} - {{ $rg->region_m }}</option>@endforeach</select></td>';
                html +=
                ...
                html += '<td><input type="text" name="area[]" class="form-control" placeholder="Area" value="N/A" style="width: 200px;"></td>';
                html +=
                    '<td><select required name="area_region_c[]" }}" class="form-control region_c disabled_field"><option value="0" selected>None</option>@foreach ($region as $rg)<option value="{{ $rg->region_c }}" {{ $rg->region_c == $issuance_of_preops[0]->operation_type_id ? '
                selected ' : '
                ' }}>{{ $rg->abbreviation }} - {{ $rg->region_m }}</option>@endforeach</select></td>';
                html +=
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("change", ".area_region_c", function() {
