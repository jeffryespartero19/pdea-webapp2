...
<section class="content">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Add Suspect Category Information</h3>
        </div>
        <div class="card-body">
            <form action="/suspect_category_add" role="form" method="post">
                @csrf
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Save Suspect Category</button>
                </div>
            </form>
        </div>
        <div class="card-footer">
            <h6>Create Suspect Category maintenance data.</h6>
        </div>
    </div>
    <!-- /.card -->
