...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Suspect Category</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" onclick="removeCokie();">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('suspect_category_list') }}">Suspect Category List</a></li>
                    <li class="breadcrumb-item active">Edit Suspect Category</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Edit Suspect Category Information</h3>
        </div>
        <div class="card-body">
            <form action="/suspect_category_edit/{{ $suspect_category[0]->id }}" role="form" method="post">
                @csrf
                @method('PATCH')
                ...
                <div class="custom-control custom-checkbox mb-2">
                    <input name="hvt" class="custom-control-input" type="checkbox" id="customCheckbox2" {{ $suspect_category[0]->hvt == true ? 'checked' : '' }}>
                ...
                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-primary">Update Suspect Category</button>
                </div>
            </form>
        </div>
        <div class="card-footer">
            <h6>Update Suspect Category maintenance data.</h6>
        </div>
    </div>
    <!-- /.card -->
