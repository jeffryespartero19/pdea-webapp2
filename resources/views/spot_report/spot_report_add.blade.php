                ...
                <div class="row">
                    <div class="form-group col-4" style="margin: 0px;">
                        <div>
                            ...
                            <span id="spot_report_error" hidden style="float: right; color:red" for="">Spot Report
                                Number Exist</span>
                        </div>
                        <div class="input-group mb-3">
...
<div hidden>
    <table class="AddSusHidden">
        <tr class="suspect_details suspect_detailsHIDDEN">
            ...
            <td><input type="text" name="whereabouts[]" style="width: 200px;" class="form-control"></td>
            <td><input type="text" name="remarks[]" style="width: 200px;" class="form-control"></td>
            <td class="mt-10"><button type="button" class="badge badge-danger delRow"><i class="fa fa-trash"></i>
                    Delete</button>
            </td>
        </tr>
    </table>
